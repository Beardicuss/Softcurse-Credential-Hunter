...
const statusTone = (count: number): string =>
  count > 0 ? "text-[var(--c-cyan)]" : "text-[var(--c-cyan-dim)]";
...
export default function AdminDashboard() {
  ...
  const healthSummary = useMemo(() => {
    ...
    const validRatio =
      totalValidated > 0 ? validation.valid / totalValidated : 0;
    const staleRatio =
      totals.confirmedKeys > 0 ? freshness.stale / totals.confirmedKeys : 0;
    ...
    <div className="min-h-screen p-8 relative">
      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            >
              ...
              <DialogContent className="glass-panel border-[var(--c-orange)] bg-[var(--c-bg)]">
                <DialogHeader>
                  <DialogTitle className="data-text text-[var(--c-orange)] tracking-widest uppercase">
                ...
                <div className="grid gap-4 py-4 mt-2">
                  <Input
                    ...
                    className="glass-panel text-[var(--c-text)] data-text"
                  ...
                  <Button
                    ...
                    onClick={() =>
                      addProviderMutation.mutate({ provider: newProviderName })
                    }
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1.45fr_0.95fr] gap-6">
          <div className="glass-panel p-6 space-y-5">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="data-text text-[11px] text-[var(--c-cyan-dim)] uppercase tracking-[0.35em] mb-2">
                  Snapshot Core
                </p>
                <h2 className="hero-text text-5xl leading-none">
                  Softcurse Hunter Surface
                </h2>
                <p className="text-[var(--c-cyan-dim)] mt-3 max-w-2xl text-sm">
                  This panel now reads the frozen contract snapshot instead of
                  scraping UI-local assumptions. It shows source yield,
                  freshness pressure, validation confidence, and which provider
                  families are actually worth attention.
                </p>
              </div>
              <div className="text-right min-w-[180px]">
                <div className="text-[11px] uppercase tracking-[0.35em] text-[var(--c-cyan-dim)] data-text mb-2">
                  Contract
                </div>
                ...
                <div className="text-[11px] uppercase tracking-[0.28em] text-[var(--c-cyan-dim)] mt-3">
                  Generated
                </div>
                <div className="data-text text-sm mt-1">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="glass-panel p-4 border-[var(--c-border)]">
                <div className="flex items-center gap-2 text-[var(--c-cyan-dim)] text-xs uppercase tracking-[0.25em] mb-2">
                  <Search className="h-3.5 w-3.5" /> Candidates
                </div>
                <div className="hero-text text-3xl">
                  {healthSummary.totals.candidates}
                </div>
              </div>
              <div className="glass-panel p-4 border-[var(--c-border)]">
                <div className="flex items-center gap-2 text-[var(--c-cyan-dim)] text-xs uppercase tracking-[0.25em] mb-2">
                  <Shield className="h-3.5 w-3.5" /> Confirmed Keys
                </div>
                <div className="hero-text text-3xl">
                  {healthSummary.totals.confirmedKeys}
                </div>
              </div>
              <div className="glass-panel p-4 border-[var(--c-border)]">
                <div className="flex items-center gap-2 text-[var(--c-cyan-dim)] text-xs uppercase tracking-[0.25em] mb-2">
                  <Database className="h-3.5 w-3.5" /> Commits
                </div>
                <div className="hero-text text-3xl">
                  {healthSummary.totals.confirmedCommits}
                </div>
              </div>
              <div className="glass-panel p-4 border-[var(--c-border)]">
                <div className="flex items-center gap-2 text-[var(--c-cyan-dim)] text-xs uppercase tracking-[0.25em] mb-2">
                  <Layers3 className="h-3.5 w-3.5" /> Providers
                </div>
                <div className="hero-text text-3xl">
                  {healthSummary.totals.providers}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="glass-panel p-5 border-[var(--c-border)]">
                <div className="flex items-center gap-2 text-[var(--c-cyan-dim)] text-xs uppercase tracking-[0.25em] mb-3">
                  <Activity className="h-3.5 w-3.5" /> Validation Health
                </div>
                <div
                  className={`hero-text text-4xl ${bucketTone(healthSummary.validRatio)}`}
                >
                  {formatPct(healthSummary.validRatio)}
                </div>
                <div className="mt-3 w-full h-1 bg-[var(--c-border)] overflow-hidden">
                  <div
                    className="h-1 bg-[var(--c-cyan)]"
                    style={{ width: `${healthSummary.validRatio * 100}%` }}
                  />
                </div>
                <div className="grid grid-cols-3 gap-2 mt-4 text-xs data-text">
                  <div>
                    <div className="text-[var(--c-cyan-dim)] uppercase tracking-widest">
                      Valid
                    </div>
                    <div className="text-green-400 text-lg">
                      {healthSummary.validation.valid}
                    </div>
                  </div>
                  <div>
                    <div className="text-[var(--c-cyan-dim)] uppercase tracking-widest">
                    ...
                    <div className="text-[var(--c-magenta)] text-lg">
                      {healthSummary.validation.invalid}
                    </div>
                  </div>
                  <div>
                    <div className="text-[var(--c-cyan-dim)] uppercase tracking-widest">
                    ...
                    <div className="text-yellow-400 text-lg">
                      {healthSummary.validation.unknown}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-panel p-5 border-[var(--c-border)]">
                <div className="flex items-center gap-2 text-[var(--c-cyan-dim)] text-xs uppercase tracking-[0.25em] mb-3">
                  <Clock className="h-3.5 w-3.5" /> Freshness Pressure
                </div>
                <div
                  className={`hero-text text-4xl ${bucketTone(1 - healthSummary.staleRatio)}`}
                >
                  {healthSummary.freshness.revalidationSuggested}
                </div>
                <div className="text-xs text-[var(--c-cyan-dim)] uppercase tracking-widest mt-2">
                  Need revalidation
                </div>
                <div className="grid grid-cols-3 gap-2 mt-4 text-xs data-text">
                  <div>
                    ...
                    <div className="text-[var(--c-cyan)] text-lg">
                      {healthSummary.freshness.fresh}
                    </div>
                  </div>
                  <div>
                    <div className="text-[var(--c-cyan-dim)] uppercase tracking-widest">
              ...
              <div className="glass-panel p-5 border-[var(--c-border)]">
                <div className="flex items-center gap-2 text-[var(--c-cyan-dim)] text-xs uppercase tracking-[0.25em] mb-3">
                  <Sparkles className="h-3.5 w-3.5" /> Validation Tiers
                </div>
                <div className="space-y-3 text-sm data-text">
                  <div className="flex items-center justify-between">
                    <span className="uppercase tracking-widest text-[var(--c-cyan-dim)]">
                      High
                    </span>
                    <span className="text-[var(--c-cyan)]">
                      {healthSummary.validation.byTier.high}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="uppercase tracking-widest text-[var(--c-cyan-dim)]">
                    ...
                    <span className="text-yellow-400">
                      {healthSummary.validation.byTier.medium}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="uppercase tracking-widest text-[var(--c-cyan-dim)]">
                    ...
                    <span className="text-[var(--c-magenta)]">
                      {healthSummary.validation.byTier.low}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="uppercase tracking-widest text-[var(--c-cyan-dim)]">
                    ...
                    <span className="text-gray-400">
                      {healthSummary.validation.byTier.unknown}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="glass-panel p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="data-text data-cyan tracking-widest uppercase">
                <span className="decorator"></span>Pipeline Alerts
              </h3>
              <span
                className={`text-xs uppercase tracking-[0.3em] ${failedQueries.length ? "text-[var(--c-magenta)]" : "text-[var(--c-cyan)]"}`}
              >
                {failedQueries.length
                  ? `${failedQueries.length} active`
                  : "clear"}
              </span>
            </div>
            ...
            <div className="space-y-3 max-h-[420px] overflow-auto pr-2">
              {snapshotLoading ? (
                <div className="glass-panel p-6 flex items-center justify-center">
                  <Loader2 className="h-6 w-6 animate-spin text-[var(--c-cyan)]" />
                </div>
              ) : failedQueries.length ? (
                failedQueries.map((query, index) => (
                  <FailedQueryCard
                    key={`${query.source || "src"}-${query.query || "query"}-${index}`}
                    query={query}
                  />
                ))
              ) : (
        ...
        <div className="glass-panel p-6">
          <div className="flex items-center justify-between mb-5">
            <h2 className="data-text data-cyan tracking-widest uppercase">
              <span className="decorator"></span>Top Provider Yield
            </h2>
            <span className="text-xs uppercase tracking-[0.28em] text-[var(--c-cyan-dim)]">
              Snapshot-ranked providers
            </span>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            {topProviders.length ? (
              topProviders.map(provider => (
                <SnapshotProviderCard
        ...
        {statusData && (
          <div className="glass-panel p-6">
            <h2 className="data-text data-cyan mb-4 tracking-widest uppercase border-b border-[var(--c-border)] pb-2 flex justify-between items-center">
              <span>
                <span className="decorator"></span>PROVIDER FALLBACK CHAIN
              </span>
              <Dialog
                onOpenChange={open => {
                  if (!open) {
              ...
              >
                <DialogTrigger asChild>
                  <Button
                    variant="outline"
                    className="h-8 border-[var(--c-cyan)] text-[var(--c-cyan)] hover:bg-[var(--c-cyan)] hover:text-black"
                  >
                ...
                <DialogContent className="glass-panel border-[var(--c-cyan)] bg-[var(--c-bg)]">
                  <DialogHeader>
                    <DialogTitle className="data-text data-cyan">
                      ADD NEW KEY
                    </DialogTitle>
                  </DialogHeader>
                  <div className="grid gap-4 py-4 mt-2">
                    <Input
                      ...
                      onChange={e => setAddKeyProvider(e.target.value)}
                    />
                    <Input
                    ...
                    <Select
                      onValueChange={val =>
                        setAddKeyValidity(val as KeyValidity)
                      }
                      value={addKeyValidity}
                    >
                      ...
                      <SelectContent className="glass-panel bg-[var(--c-bg)] border-[var(--c-cyan)]">
                        <SelectItem
                          value="valid"
                          className="data-text text-green-500 hover:text-green-500 hover:bg-black focus:bg-[var(--c-cyan)] focus:text-black"
                        >
                          valid
                        </SelectItem>
                        <SelectItem
                          value="unknown"
                          className="data-text text-yellow-500 hover:text-yellow-500 hover:bg-black focus:bg-[var(--c-cyan)] focus:text-black"
                        >
                          unknown
                        </SelectItem>
                      </SelectContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 font-mono text-sm data-text">
              <div className="border border-[var(--c-border)] px-4 py-3">
                <div className="text-[var(--c-cyan-dim)] text-xs uppercase">
                  Service
                </div>
              ...
              <div className="border border-[var(--c-border)] px-4 py-3">
                ...
                <div className="text-[var(--c-cyan)] mt-1">
              ...
              <div className="border border-[var(--c-border)] px-4 py-3">
                ...
                <div className="text-[var(--c-orange)] mt-1">
                  {snapshot?.contractVersion || "hunter.v1"}
                </div>
              </div>
            </div>
        ...
        <div className="glass-panel p-6">
          <div className="flex items-center justify-between mb-5">
            <h2 className="data-text data-cyan tracking-widest uppercase">
              <span className="decorator"></span>Manual Key Pool Control
            </h2>
            <span className="text-xs uppercase tracking-[0.28em] text-[var(--c-cyan-dim)]">
              Legacy controls kept online during UI rebuild
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {statsLoading ? (
              ...
              stats?.map(stat => {
                ...
                const healthRatio =
                  stat.totalKeyCount > 0
                    ? stat.validKeyCount / stat.totalKeyCount
                    : 0;
                const barColor =
                  healthRatio >= 0.5
                    ? "bg-green-500"
                ...
                return (
                  <div
                    key={stat.provider}
                    className={`glass-panel p-6 cursor-pointer group transition-all duration-300 ${
                      selectedProvider === stat.provider
                        ? "shadow-[0_0_15px_rgba(0,255,255,0.3)] border-[var(--c-cyan)]"
                        : ""
                    ...
                    onClick={() => {
                      ...
                      setSelectedProvider(prev =>
                        prev === stat.provider ? null : stat.provider
                      );
                    }}
                  >
                    <div className="flex justify-between items-center mb-4">
                      ...
                      {isHealthy && (
                        <span
                          className="data-text text-xs border border-green-500/60 text-green-400 px-2 py-1"
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-2 data-text">
                      <div>
                        <p className="text-[11px] text-[var(--c-cyan-dim)] uppercase tracking-widest">
                          Valid Keys
                        </p>
                        <p className="text-2xl font-bold data-cyan">
                          {stat.validKeyCount}
                        </p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold data-magenta">
                          {stat.failedRequests}
                        </p>
                      </div>
                    </div>
                    <div className="pt-4 border-t border-[var(--c-border)] flex flex-col gap-4">
                      ...
                      >
                        {pendingDiagProvider === stat.provider ? (
          ...
          <div className="glass-panel p-6">
            <h2 className="data-text data-cyan mb-4 tracking-widest uppercase border-b border-[var(--c-border)] pb-2 flex items-center justify-between">
              <span>
                ...
                {selectedProvider} :: SYSTEM_KEYS
              </span>
              <div className="flex items-center gap-3">
                {keysLoading && (
                  <Loader2 className="h-4 w-4 animate-spin data-cyan" />
                )}
                <button
            ...
            <div className="mt-4">
              {keysLoading ? (
                <div className="flex justify-center py-12">
                  <span className="data-text data-cyan tracking-widest uppercase animate-pulse">
                    FETCHING NODES...
                  </span>
                </div>
              ) : keys && keys.length > 0 ? (
                <div className="space-y-4">
                  {keys.map(key => (
                    <div
                      key={key.id}
                      className="flex flex-col md:flex-row items-start md:items-center justify-between p-4 border border-[var(--c-border)] bg-[#050810] glass-panel group transition-all duration-300 hover:border-[var(--c-cyan-dim)]"
                    >
                      <div className="flex-1 mb-4 md:mb-0">
                        <div className="flex items-center gap-3 data-text">
                          <p
                            ...
                            onClick={e => {
                              e.stopPropagation();
                              toggleKeyReveal(selectedProvider, key.id);
                            }}
                          >
                            {revealedKeyValues.get(key.id) || key.keyMasked}
                          </p>
                          <button
                          ...
                          {revealedKeys.has(key.id) && (
                            <button
                              ...
                              onClick={e => {
                                e.stopPropagation();
                                copyRevealedKey(selectedProvider, key.id);
                              }}
                            >
                          ...
                          {key.validity === "valid" && (
                            <span className="text-xs border border-green-500 text-green-500 px-2 py-0.5 flex items-center gap-1 shadow-[0_0_8px_rgba(34,197,94,0.3)]">
                              <CheckCircle className="h-3 w-3" /> VALID
                            </span>
                          )}
                          {key.validity === "invalid" && (
                            <span className="text-xs border border-[var(--c-magenta)] text-[var(--c-magenta)] px-2 py-0.5 flex items-center gap-1 shadow-[0_0_8px_rgba(255,0,255,0.3)]">
                              <AlertCircle className="h-3 w-3" /> INVALID
                            </span>
                          )}
                          {key.validity === "rate_limited" && (
                            <span className="text-xs border border-yellow-500 text-yellow-500 px-2 py-0.5 flex items-center gap-1 shadow-[0_0_8px_rgba(234,179,8,0.3)]">
                              <AlertCircle className="h-3 w-3" /> RATE_LMT
                            </span>
                          )}
                          {key.validity === "unknown" && (
                            <span className="text-xs border border-gray-500 text-gray-500 px-2 py-0.5 flex items-center gap-1">
                              UNKNOWN
                            </span>
                          )}
                        </div>
                      ...
                      <div className="flex flex-row gap-2 w-full md:w-auto">
                        <Dialog>
                            ...
                            <Button
                              ...
                              onClick={e => {
                                ...
                                setEditKeyObj({
                                  id: key.id,
                                  provider: selectedProvider,
                                  validity: key.validity as KeyValidity,
                                  keyValue: "",
                                });
                              }}
                            >
                          ...
                          {editKeyObj && editKeyObj.id === key.id && (
                            <DialogContent className="glass-panel border-[var(--c-cyan)] bg-[var(--c-bg)]">
                              <DialogHeader>
                                <DialogTitle className="data-text data-cyan flex items-center">
                                  <span className="decorator"></span>EDIT KEY:{" "}
                                  {key.keyMasked}
                                </DialogTitle>
                              </DialogHeader>
                              <div className="grid gap-4 py-4 mt-2">
                                ...
                                <Select
                                  onValueChange={val =>
                                    setEditKeyObj({
                                      ...editKeyObj,
                                      validity: val as KeyValidity,
                                    })
                                  }
                                  value={editKeyObj.validity}
                                >
                                  <SelectTrigger className="glass-panel !mb-2 data-text">
                                    <SelectValue placeholder="Validity Status" />
                                  </SelectTrigger>
                                  <SelectContent className="glass-panel bg-[var(--c-bg)] border-[var(--c-cyan)]">
                                    <SelectItem
                                      value="valid"
                                      className="data-text text-green-500 focus:bg-green-500 focus:text-black hover:bg-green-500 hover:text-black"
                                    >
                                      valid
                                    </SelectItem>
                                    <SelectItem
                                      value="invalid"
                                      className="data-text text-[var(--c-magenta)] focus:bg-[var(--c-magenta)] focus:text-white hover:bg-[var(--c-magenta)] hover:text-white"
                                    >
                                      invalid
                                    </SelectItem>
                                    <SelectItem
                                      value="rate_limited"
                                      className="data-text text-yellow-500 focus:bg-yellow-500 focus:text-black hover:bg-yellow-500 hover:text-black"
                                    >
                                      rate_limited
                                    </SelectItem>
                                    <SelectItem
                                      value="unknown"
                                      className="data-text text-gray-500 focus:bg-gray-500 focus:text-white hover:bg-gray-500 hover:text-white"
                                    >
                                      unknown
                                    </SelectItem>
                                  </SelectContent>
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    editKeyMutation.mutate({
                                      ...
                                      provider: selectedProvider,
                                      keyValue:
                                        editKeyObj.keyValue || undefined,
                                      validity: editKeyObj.validity,
                                    })
                                  }
                                  disabled={editKeyMutation.isPending}
                                >
                                  {editKeyMutation.isPending ? (
                                    <Loader2 className="h-4 w-4 animate-spin" />
                                  ) : (
                                    "[ OVERWRITE KEY ]"
                                  )}
                ...
                <div className="py-12 flex items-center justify-center border border-dashed border-[var(--c-border)] glass-panel">
                  <p className="data-text uppercase tracking-widest text-[var(--c-cyan-dim)] text-xs flex items-center gap-2">
                    <AlertCircle className="h-4 w-4" /> NO KEYS DETECTED ON
                    EXPANSE
                  </p>
                </div>
              )}
    ...
    <div className="glass-panel p-5 border-[var(--c-border)]">
      <div className="flex items-start justify-between gap-3 mb-4">
        <div>
          ...
          <p className="text-[11px] uppercase tracking-[0.28em] text-[var(--c-cyan-dim)] mt-1">
            Source-ranked provider family
          </p>
        </div>
        <div
          className={`text-xs uppercase tracking-[0.28em] ${statusTone(provider.valid)}`}
        >
      ...
      <div className="grid grid-cols-2 gap-3 text-xs data-text">
        ...
        <div>
          ...
          <div className="text-[var(--c-cyan)] text-lg">
            {provider.avgConfidence.toFixed(2)}
          </div>
        </div>
        <div>
          <div className="text-[var(--c-cyan-dim)] uppercase tracking-widest">
          ...
          <div className="text-yellow-400 text-lg">
            {provider.revalidationSuggested}
          </div>
        </div>
      </div>
    </div>
