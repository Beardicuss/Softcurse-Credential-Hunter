  ...
  return (
    <div className="glass-panel p-6 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <Dialog open={dialogOpen} onOpenChange={open => { setDialogOpen(open); if (!open) setProviderName(""); }}>
          ...
          <DialogContent className="glass-panel border-[var(--c-orange)] bg-[var(--c-bg)]">
            <DialogHeader><DialogTitle className="data-text text-[var(--c-orange)] tracking-widest uppercase">INITIALIZE NEW PROVIDER</DialogTitle></DialogHeader>
            <div className="grid gap-4 py-4 mt-2">
              ...
              <Button className="w-full bg-[var(--c-orange)] text-black hover:bg-[#ff8f59] mt-2 font-mono tracking-widest" onClick={createProvider} disabled={isCreatingProvider || !providerName.trim()}>
